...
\`\`\``,
  ...
  {
    id: 'origami-card',
    name: '3D Origami Card',
    description: 'Product card that unfolds in 3D with sequential reveal animations - like unfolding paper with realistic physics',
    category: 'cards',
    tags: ['card', '3d', 'origami', 'unfold', 'product', 'interactive'],
    preview: OrigamiCard,
    code: `'use client'
...
export default function OrigamiCard() {
  ...
  return (
    ...
    dependencies: ['framer-motion', 'lucide-react', 'react'],
    integration: `Add to your product page:
...
**Key Features:**
- 3D perspective transforms with \`perspective: 1500px\`
- Sequential unfold animation (middle section first, then bottom)
- Realistic paper crease gradients
- Dynamic shadows that deepen when expanded
